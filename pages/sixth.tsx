...
const SixthExperiment: NextPage = () => {
    ...
    const initialSeconds = new Date().getHours()*60*60+new Date().getMinutes()*60+new Date().getSeconds();
    const [allSeconds,setAllSeconds] = useState<number>(initialSeconds);
    ...
    const [newSecond,setNewSecond] = useState<number>(0);
